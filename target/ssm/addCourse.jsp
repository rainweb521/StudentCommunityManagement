...
<div class="container">
    <form action="/addCourse" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="name" placeholder="社团名" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="credit" name="credit" placeholder="社团学分" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="amount" name="amount" placeholder="社团容量" required>
        </div>
        <div class="form-group">
            <label for="detail">社团描述</label>
            <input type="text" class="form-control" id="detail" name="detail" placeholder="社团描述" required>
        </div>
