    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/showAllClasses">所有社团</a></li>
                <li><a href="/showMyClasses">我的社团</a></li>
        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">社团所属社团</h3>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">社团已选人数/容量</h3>
                </div>
                <div class="panel-body">
